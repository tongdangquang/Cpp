...
{
// việc nhập d, c và cấp phát bộ nhớ cho từng dòng phải đi liền với nhau, túc là cùng ở trong hàm void hoặc cùng ở ngoài hàm void
...
int main ()
{
    int d = 3;
    int c = 4;
    /* Sử dụng cách khai báo mảng con trỏ **m (hay còn gọi là con trỏ trỏ con trỏ) thì phải cấp phát bộ nhớ 2 lần,
