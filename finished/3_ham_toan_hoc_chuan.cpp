...
int main ()
{
    ...
    // 5. hàm tính giá trị trần ceil(), giá trị sàn floor(), giá trị làm tròn round()
    double x = 3.4;
    double c = ceil(x);
    double f = floor(x);
    double r = round(x);
    ...
    // 11. hàm làm tròn n chứ số sau dấu phẩy của số thập phân 
    float pi = 3.14593740084843838;
    cout << "Pi = " << fixed << setprecision(7) << pi << endl;
}